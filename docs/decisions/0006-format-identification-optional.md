...
Sequenced in the [format-identification-optional plan](../plans/format-identification-optional.md), a companion to the [refactoring plan](../plans/refactoring-plan.md)'s Phase 1.
